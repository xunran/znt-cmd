...
var RequiredLiveColumns = []ColumnRequirement{
	...
	{Table: "agent_delegations", Column: "tenant_id", NotNull: true},
	{Table: "agent_delegations", Column: "source_tool_call_id", NotNull: true},
	{Table: "agent_delegations", Column: "provider_agent_id", NotNull: true},
	{Table: "agent_delegations", Column: "status", NotNull: true},
	...
	{Table: "external_delivery_outbox", Column: "tenant_id", NotNull: true},
	{Table: "external_delivery_outbox", Column: "provider", NotNull: true},
	{Table: "external_delivery_outbox", Column: "external_task_id", NotNull: true},
	{Table: "external_delivery_outbox", Column: "idempotency_key", NotNull: true},
	{Table: "external_delivery_outbox", Column: "status", NotNull: true},
...
var RequiredLiveIndexes = []string{
	...
	"idx_agent_delegations_parent_run",
	"idx_agent_delegations_trace",
	"idx_agent_delegations_child_run",
	...
	"idx_external_delivery_outbox_status",
	"idx_external_delivery_outbox_task",
